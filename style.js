(function (blink) {
	...
	yam_demoStyle.prototype = _.extend({}, new blink.theme.styles.basic(), yam_demoStyle.prototype);

	blink.theme.styles['yam_demo'] = yam_demoStyle;
